...
?>
    ...
    <div class="site-section" style="background-image: url('images/fond3.jpg');">
        <div class="container ">
            <div class="row">

                <div class="col-md-5 pr-md-5 order-md-1">
                    <div class="display-3" style="color:white; font-weight:500"> </br> <strong>MADE IN WORLD</strong>
                    </div>
                    ...
                    <p><a href="produits.php" class="btn btn-outline-primary btn-sm rounded-0 p-2 px-4">Voir la box du
                            mois</a></p>
                </div>

                <div class="col-md-6 bg-image bg-sm-height mb-5 mb-md-0 order-md-2 fondjaune"
                     style=" background-image: url('images/box 3 produits home.png');"
            ...
            <div class="row liste">
                ...
                <div class="col-md-6 col-lg-4 " data-aos="fade" data-aos-delay="300">
                    <div class="d-flex align-items-center">
                        <div class="mr-3"></div>
                        <div class="">
                            <h2 class="text-black">Des produits </h2> <strong class="text-black"> 100%</strong> Made in
                            world
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 " data-aos="fade" data-aos-delay="700">
                    <div class="d-flex align-items-center">
                        <div class="mr-3"></div>
                        <div class="">
                            <h2 class="text-black">Un livre de recette </h2> <strong class="text-black">
                                Voyager </strong> et retrouver
                            les coutumes pays
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 bg-image bg-sm-height mb-5 mb-md-0 order-md-2"
                     style="background-image: url('images/fond1.png');"
                     data-aos="fade-up"></div>
                <div class="col-md-6 pr-md-5 order-md-1">
                    <h2 class="display-4 text-white "><strong>LA BOX</strong> </br> Made in World</h2>
                    <p class=" commentaire">Made in World vous propose un voyage culinaire exceptionnel pour savourer
                        des plats
                        typiques, cuisiner des recettes originales et découvrir avec curiosité et étonnement la cuisine
                        du monde.</p>
    ...
    <div class="site-section section-about">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="CarteP">
                        <img src="images/boite classique2.jpg" alt="Image" class="w-50 mb-4 rounded" data-aos="fade"
                             data-aos-delay="0">
                        <h4>La classique</h4>
                ...
                <div class="col-md-4 ">
                    <div class="CarteP">
                        <img src="images/boite sur mesure2.jpg" alt="Image" class="w-50 mb-4 rounded" data-aos="fade"
                             data-aos-delay="300">
                        <h4>La sur mesure</h4>
                ...
                <div class="col-md-4">
                    <div class="CarteP">
                        <img src="images/boite eco2.jpg" alt="Image" class="w-50 mb-4 rounded" data-aos="fade"
                             data-aos-delay="700">
                        <h4>L'économique </h4>
            ...
            <div class="block-13 nonloop-block-13 owl-carousel" data-aos="fade">
                ...
                <div class="p-4">
                    <div class="block-47 d-flex">
                        ...
                        <blockquote class="block-47-quote">
                            <p>&ldquo;Il y a une dizaine de jours, j’ai reçu un jolis colis de la part de Made in world.
                                C’est un
                                concept de box culinaire très sympa puisqu’il nous permet de voyager en cuisine et à
                                table! Je vous le
                                recommande vivement! :)&rdquo;</p>
                            <cite class="block-47-quote-author">&mdash; Cathy,T <a href="#">Lyon</a></cite>
                        </blockquote>
                    </div>
                </div>
                ...
                <div class="p-4">
                    <div class="block-47 d-flex">
                        ...
                        <blockquote class="block-47-quote">
                            <p>&ldquo;Excellente cette box ! le service client est au top ! ils ont bien su me
                                renseigner par échange
                                de mail en étant très cordial. Les produits de la box sont originaux et bons
                                !&rdquo;</p>
                            <cite class="block-47-quote-author">&mdash; Sylvie,C <a href="#">Bordeaux</a></cite>
                        </blockquote>
                    </div>
                </div>
                ...
                <div class="p-4">
                    <div class="block-47 d-flex">
                        ...
                        <blockquote class="block-47-quote">
                            <p>&ldquo;Très bonne idée de cadeau. On attend de voir arriver la premiere box pour voir le
                                contenu réel et
                                pour voir si le rapport qualité prix est bon.&rdquo;</p>
                            <cite class="block-47-quote-author">&mdash; John, G <a href="#">Toulouse</a></cite>
                        </blockquote>
                    </div>
                </div>
                ...
                <div class="p-4">
                    <div class="block-47 d-flex">
                        ...
                        <blockquote class="block-47-quote">
                            <p>&ldquo;J'ai offert un abonnement à une personne de mon entourage car après avoir testé
                                cette box, j'en
                                étais très satisfait. C'est un bon concept pour découvrir de nouveaux produits, ou faire
                                un cadeau utile
                                à une personne qui aime cuisine et manger. :)&rdquo;</p>
                            <cite class="block-47-quote-author">&mdash; Paul,H <a href="#">Alsace</a></cite>
                        </blockquote>
                    </div>
                </div>
