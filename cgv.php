    ...
    <div class="row mb-5">
        ...
        <div class="post-entry bg-white">
          <p>
            ...
            <p>Les présentes Conditions Générales de Services (« CGV »), ainsi que les Conditions Particulières (« CP ») spécifiques au(x) Service(s) (telle que la notion est définie ci-après) commandé(s), ont pour objet de définir les conditions et modalités de souscription, de mise à disposition et d’utilisation des Services proposés par Made in World sur son site Internet madeinworld.fr.</p>

            <p><b>1.2 Acceptation des CGV</b></p>

            <p>L’acceptation et/ou la validation par le Client (telle que la notion est définie ci-après) d’un Bon de Commande (telle que la notion est définie ci-après) généré par Made in World emporte l’acceptation pleine et entière, sans restrictions ni réserves, des présentes CGV et des CP applicables au(x) Service(s) concerné(s). Le Contrat (telle que la notion est définie ci-après) entre Made in World et le Client ne prendra effet qu’à l’encaissement complet du paiement des Services souscrits et définis dans le(s) Bon(s) de Commande correspondant(s).</p>

            <p><b>1.3 Contrat – hiérarchie contractuelle</b></p>

            <p>Les présentes CGV, les CP spécifiques au(x) Service(s) souscrit(s) et le(s) Bon(s) de Commande forment le contrat conclu entre les Parties (ci-après le « Contrat »).

            Ces documents contractuels prévalent sur toute proposition, offre commerciale, échange de lettres antérieures et postérieures à la conclusion des présentes, ainsi que sur toute autre disposition figurant dans les documents échangés entre les Parties et relatifs à l’objet des CGV et des CP.

            En cas de contradiction entre les présentes CGV, les CP applicables au(x) Service(s) souscrit(s) et le(s) Bon(s) de Commande correspondant(s), les dispositions contractuelles d’un rang supérieur prévaudront sur celles du rang inférieur dans l’ordre suivant : (i) les présentes CGV ; (ii) les CP et (iii) le Bon de Commande.</p>

            <p><b>1.4 Modifications des CGV et/ou des CP</b></p>

            <p>Le Client est informé que les présentes CGV et les CP peuvent faire l’objet de modifications à tout moment. Ces modifications seront applicables immédiatement aux nouveaux Bons de Commande et/ou aux nouveaux Clients. Pour les Clients dont les Services sont en cours d’utilisation, Made in World les informera des modifications ainsi apportées aux présentes CGV et/ou aux CP applicables au(x) Service(s) souscrit(s).

            Toutefois, les modifications des CGV et/ou des CP résultant d’une mise en conformité légale ou réglementaire pourront intervenir immédiatement et sans préavis, dans la mesure où Made in World ne les maîtrise pas.

             Si le Client refuse les modifications apportées, il aura la faculté soit de résilier le(s) Service(s) concerné(s) dans un délai maximum d’un (1) mois à compter de la notification adressée par Made in World, soit de demander à ce que les anciennes CGV restent applicables jusqu’à l’échéance de son Contrat. Passé ce délai, les modifications apportées aux CGV et aux CP applicables seront considérées comme acceptées par le Client.</p>
            ...
            <p><b>3.5 Bon de Commande :</b> désigne le bon de commande accessible en ligne sur le site Internet de la société Made in World https://madeinworld.fr, dûment complété suivant les Services et les caractéristiques techniques de chacun d’entre eux choisis par le Client sur le site Internet d’Made in World et transmis par le Client à Made in World ;</p>
            ...
            <p><b>3.15 Espace Client :</b> désigne l’espace privatif du Client accessible en ligne sur le site Internet de la société Made in World à l’adresse URL suivante https://controlpanel.madeinworld.fr, contenant notamment les informations relatives aux Services fournis par la société Made in World et permettant d’y effectuer les opérations de gestion des Services ;</p>
            ...
            <p><b>3.23 Politique de Confidentialité :</b> document accessible à l’adresse URL https://madeinworld.fr/company/privacy.html faisant partie intégrante des présentes CGV et ayant pour objet de définir les conditions dans lesquelles Made in World collecte et traite les Données Personnelles des Clients et utilisateurs de ses Services ;</p>
            ...
             
            <p><b>3.30 Revendeur(s) :</b> désigne toute personne physique ou morale exerçant son activité en qualité de professionnel de l’Internet, à l’exclusion de tout consommateur, qui contracte en son nom auprès de la société Made in World et pour le compte de ses propres clients finaux. Dans le cadre des présentes CGV, il souscrit aux mêmes engagements et obligations que ceux impartis au Client ;</p>
            ...
            <p><b>3.32 Service(s) :</b> désigne(nt) l’ensemble des prestations et services fournis par Made in World, décrits sur son site Internet madeinworld.fr et dont la souscription et l’utilisation sont régies par les présentes CGV et les CP spécifiques applicables ;</p>
            ...
            Les présentes CGV resteront en vigueur jusqu’à l’expiration des dernières CP applicables aux Services dont la durée est prévue dans le Bon de Commande. Aucun paiement ne fera l’objet d’un remboursement, même en cas de suspension, d’annulation ou de transfert de Services avant l’issue de la période contractuelle, sauf dispositions particulières prévues ci-dessous.
            ...
            Il est entendu que la souscription aux Service(s) par le Client, y compris pour une période d’essai, conformément aux modalités indiquées par Made in World, implique l’acceptation totale des termes des présentes CGV et des CP correspondantes.</p>
            ...
            <p>La nature et le type des Services fournis par Made in World sont décrits dans le Bon de Commande accepté par le Client et les CP applicables dont le Client aura accepté les termes lors de la souscription auxdits Services sur le site Internet https://madeinworld.fr.</p>
            ...
            <p>Sauf disposition particulière des présentes CGV et des CP ou indications contraires d’Made in World, les correspondances échangées entre les Parties sont assurées essentiellement par voie électronique, via l’Espace Client et en suivant les modalités fournies par Made in World et par téléphone.
            ...
            Dans le cas où le Service comporte des Logiciels d’Editeurs de Logiciels, les termes des licences de ces derniers s’appliqueront cumulativement avec les présentes CGV. A cet égard Made in World ne peut, en aucun cas, concéder au Client plus de droits que l’Editeur de Logiciels.
            ...
            <p>Conformément aux dispositions de l’article 9.4 des présentes CGV, le Client est informé qu’Made in World ne procède à aucune sauvegarde des Données Client, si bien qu’en l’absence de sauvegarde personnelle par le Client, la suppression des Données Client liée à la résiliation est définitive.</p>
            ...
            La collecte et le traitement par Made in World des Données Personnelles de ses Clients sont établis conformément à sa Politique de Confidentialité accessible en cliquant ici : https://madeinworld.fr/company/privacy.html.
            ...
            <p>Si une ou plusieurs dispositions des présentes CGV et/ou des CP devaient être tenues pour non valides ou déclarées comme telles en application d’une loi,
            ...
            <p>Le fait que l’une ou l’autre des Parties n’ait pas exigé, temporairement ou définitivement, l’application d’une disposition des présentes
              CGV et des CP ne pourra être considéré comme une renonciation aux droits détenus par cette Partie. Tout échange de correspondances, d’écrits,
              de courriers électroniques, etc. ne saurait remettre en cause les termes des présentes CGV et des CP, sauf avenant dûment signé par les Parties ou par leurs représentants.</p>
            ...
            <p>Sauf accord préalable et écrit d’Made in World, le Client n’est pas autorisé à transférer tout ou partie des droits et obligations issues des présentes CGV et des CP,
               en particulier de faire bénéficier à des tiers de tout ou partie du Service, sauf dispositions contraires, en particulier à l’article 4 des présentes CGV.</p>
            ...
            <p>Les présentes CGV et tout litige en rapport avec les Services sont régis et interprétés au regard du droit français.</p>

            <p><b>20.2 Résolution des litiges</b></p>

            <p>Dans la mesure autorisée par la loi, avant d’entamer toute procédure judiciaire concernant un litige susceptible de survenir impliquant les présentes CGV,
            ...
            - de porter sa réclamation devant les juridictions françaises compétentes selon les présentes CGV.</p>
            ...
            <p>Il est fait attribution expresse et exclusive de compétence au Tribunal de Commerce de Paris, pour tout litige susceptible de survenir entre
              ...
              en rapport avec les présentes CGV, leur interprétation et les conséquences ainsi que tout acte les complétant ou les modifiant, notamment les CP relatives
