        ...
        <div class="row">
            <div class="col-md-4 pr-md-5 order-md-1">
                ...
                <p>On vous propose dans cette box de vous immerger dans les traditions culinaires de l'Italie. La box
                    classique est composée de 6 produits incontournables de l’Italie
                </p>
            </div>
            ...
            <div class="col-md-4  order-md-1 prixdesc">
                ...
                <?php
                  ...
                  ?>
                <p><a href="connexion.php?achat=true" class="boutonprod1">Acheter la box</a></p>
                <?php
                }?>
            </div>
        </div>
    ...
    <div class="container">
        <div class="gallery">
            ...
            <div class="gallery-item"><img src="images/pates.png" alt="Boite de pâtes"><span class="text-wrapper"><span
                        class="name">La boîte de pâtes</span><span class="title">L'incontournable ingrédient de
            ...
            <div class="gallery-item"><img src="images/vinr.png" alt="Une bouteille de vin"><span class="text-wrapper"><span
                        class="name">Le vin rouge</span><span class="title"> Un vin en bouche, boisé sélectionné par
                        notre chef
                    </span></span></div>
            <div class="gallery-item"><img src="images/livrebl.png" alt="Livre de recette "><span class="text-wrapper"><span
                        class="name">Le livre de recettes</span><span class="title">Les recettes classiques italiennes
                        d'une simplicité absolue
                    </span></span></div>
        </div>
    </div>
</div>
