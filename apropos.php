...
<div class="site-section4 ">
  ...
  <div class="flip">
    ...
    <div class="back">
      <h2>Des saveurs insoupçonnées</h2>
      <p>
      Des terres ensoleillées de Sierra Leone avec un plat de bananes plantains frit accompagné de riz, aux grandes plaines sauvages de Mongolie avec ses khuchuur de moutons. Vos sens seront transportés à chaque bouchée.</p>
    </div>
  </div>
  ...
  <div class="flip">
    ...
    <div class="back ">
      ...
      <p>
      Un livre de recettes vous sera fourni dans chaque coffret, spécialement écris par nos chefs dans le respect de la culture culinaire du pays représenté. Dans le souci de toujours vous apportez une expérience authentique.</p>
    </div>
  </div>
...
Chef Cuisinier depuis 10 ans. Mehdi met son talent au service des plus grands restaurants du monde. Cette fois-ci, c’est à Made In World qu'il pose sa toque. A travers son expérience, il confectionne des petits plats à reproduire facilement chez soi !</p>
      ...
      <div class="col-md-4">
        ...
        <div class="cadrage">
          ...
          <p class="pdesc">Aurélie supervise avec notre chef Mehdi la confection de nos recettes du tour du monde. Son goût de l’esthétique nous permet d’avoir un livre de recettes au mille et une saveurs !
          </p>
